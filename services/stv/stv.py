...
#   Ozivine: STV Video Downloader
#   Author: billybanana
#   Usage: enter the series/season/episode URL to retrieve the MPD, Licence, PSSH and Decryption keys.
#   eg: https://player.stv.tv/episode/4i00/crime/episode-1/
#   Authentication: None
#   Geo-Locking: requires a Scotland address
#   Quality: up to 1080p
#   Key Features:
#   1. Extract Video ID: Parses the STV URL to extract the series name, season, and episode number.
